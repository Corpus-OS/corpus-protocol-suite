...
Graph Protocol V1 Specification

LLM Protocol V1 Specification

Vector Protocol V1 Specification
...
Announce in release notes and capabilities().extensions.deprecated (MAY).

Emit runtime warnings on deprecated paths (SHOULD).

Maintain for ≥ one major version.

Remove in the subsequent major release.
...
Adapter SDK GitHub Repository — https://github.com/adapter-sdk
...
GitHub: github.com/adapter-sdk/standards
