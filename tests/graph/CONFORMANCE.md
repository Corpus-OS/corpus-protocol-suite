...
- `test_unknown_dialect_rejected` - Rejects unknown dialects (parametrized: unknown, sql, sparql)
- `test_known_dialect_accepted` - Accepts known dialects (parametrized: cypher, opencypher)
...
| Contains read_only flag | test_health_report.py | ✅ |
| Contains degraded flag | test_health_report.py | ✅ |
...
- [x] BatchOperations helpers work
