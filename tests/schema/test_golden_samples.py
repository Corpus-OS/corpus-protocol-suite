...
CASES: List[Tuple[str, str]] = [
    ...
    ("graph/graph_vertex_create_request.json",      "https://corpusos.com/schemas/graph/graph.envelope.request.json"),
    ("graph/graph_vertex_delete_request.json",      "https://corpusos.com/schemas/graph/graph.envelope.request.json"),
    ...
    ("graph/graph_entity_vertex.json",              "https://corpusos.com/schemas/graph/graph.types.entity.json"),
